...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5986116983').split()]
USERNAME = environ.get('USERNAME', "https://telegram.me/jacksparrroww1")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001572413887'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/New_film_movie_zone')
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1001572413887'))
...
REF_PREMIUM = 30
PREMIUM_POINT = 1500
auth_channel = environ.get('AUTH_CHANNEL', '-1001572413887')
